  ...
  const features = [
    {
      ...
      description:
        "Experience superfast speeds and 99% country coverage with UK's most awarded and reliable network",
      icon: whylyca1,
    },
    {
      id: 2,
      ...
      description:
        "Enjoy the convenience of an eSIM with seamless 5G enabled video calling, downloads or streaming",
      icon: whylyca2,
    },
    {
      id: 3,
      ...
      description:
        "With our global network, Roam within EU or call your world at no additional cost",
      icon: whylyca3,
    },
  ];
      ...
      <div className="why-lyca-container">
        ...
        {isCarouselMode ? (
          ...
          <div className="carousel-wrapper-why">
            <button
              className="carousel-btn-why carousel-btn-prev-why"
              onClick={handlePrev}
            ...
            >
              <img
                src={arrowleft}
                alt="Previous"
                className="carousel-arrow-icon-why"
              />
            </button>
            ...
            <button
              className="carousel-btn-why carousel-btn-next-why"
              onClick={handleNext}
